...
def get_file_path(stored_path: str) -> Path:
    ...
    # is_relative_to is exact (and true for an equal path) — unlike str.startswith,
    # it won't accept a sibling that merely shares a name prefix (e.g. /srv/plm-files-evil).
